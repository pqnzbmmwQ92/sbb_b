...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@TTTLL0")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/pqnzbmmwQ92/sbb_b")
    AUTONAME = os.environ.get("AUTONAME", "@TTTLL0")
