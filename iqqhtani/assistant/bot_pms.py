    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا عزيزي  {mention} **\
                        ...
                        \n\n**⌔︙ البوت خاص بسورس :** [ايــثــون](https://t.me/TTTLL0)"
        buttons = [
            (
                Button.url("تنصيب سورسنا", "https://dashboard.heroku.com/new?template=https://github.com/pqnzbmmwQ92/zuhairy"),
                Button.url(
                    "قروب المساعد",
                    "https://t.me/eithonsupport",
                ),
            )
        ]
    else:
