...
❶❷❸❹❺❻❼❽❾⓿
⓫⓬⓭⓮⓯⓰⓱⓲⓳⓴ `""")
@iqqhtani.on(admin_cmd(pattern="رموز2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎ `""")
@iqqhtani.on(admin_cmd(pattern="تمبلريه(?: |$)(.*)"))
async def iq(event):
     await edit_or_reply(event, "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **✪ ⦙  قائـمه اوامر الزغرفه :** \n✪ ⦙  `.المواليد ` \n✪ ⦙  `.اشهر مزغرفه` \n✪ ⦙  `.الاختصارات` \n✪ ⦙  `.البايو` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",)
@iqqhtani.on(admin_cmd(pattern="البايو(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**✪ ⦙  - 𝑩𝑰𝑶 𝑳𝑰𝑺𝑻 : **\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **✪ ⦙  قائـمه البايو :** \n✪ ⦙  `.بايو1 ` \n✪ ⦙  `.بايو2` \n✪ ⦙  `.بايو3 ` \n✪ ⦙  `.بايو4 ` \n✪ ⦙  `.بايو5` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
@iqqhtani.on(admin_cmd(pattern="الاختصارات(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "**✪ ⦙  - 𝑺𝑯𝑶𝑹𝑻𝑪𝑼𝑻𝑺 : **\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **✪ ⦙  قائـمه الاختصارات :** \n✪ ⦙  `.اختصارات1 ` \n✪ ⦙  `.اختصارات2` \n✪ ⦙  `.اختصارات3 ` \n✪ ⦙  `.اختصارات4 ` \n✪ ⦙  `.اختصارات5` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")
@iqqhtani.on(admin_cmd(pattern="اشهر مزغرفه(?: |$)(.*)"))
async def _(event):
...
@iqqhtani.on(admin_cmd(pattern="المواليد(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "₁₉₉₅\n"
                "₁₉₉₆\n"
...
@iqqhtani.on(admin_cmd(pattern="اختصارات1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ڪݪخـرا .\n"
                "نجَبـيہ .\n"
...
@iqqhtani.on(admin_cmd(pattern="اختصارات2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ע\n"
                "ليـشـہٰ \n"
...
@iqqhtani.on(admin_cmd(pattern="اختصارات3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "• ھھݪـﯠ\n"
                "• شلـﯛنڪہ\n"
...
@iqqhtani.on(admin_cmd(pattern="اختصارات4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "؏ـليڪ\n"
                "أඋـبڪ\n"
...
@iqqhtani.on(admin_cmd(pattern="اختصارات5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "- مٰنۅِ 💕.\n"
                "- شٰخصَ 💕.\n"
...
@iqqhtani.on(admin_cmd(pattern="بايو1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☁️ : 🕊\n" "☁️ :   ✨\n" "☁️ :   🤍\n\n" "بريئۃ ۿي، بصورۿ لطيفۃ ڪالاطفال🎀")

@iqqhtani.on(admin_cmd(pattern="بايو2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☘️ 💕\n" "☘️ 💕\n" "☘️ 💕\n" "☘️ دمت لي شيئاً جميلاً لا ينتهي💕")

@iqqhtani.on(admin_cmd(pattern="بايو3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "𓋜┊𓆩 ➝  ˛⁽🇮🇶₎⇣ 𓆪\n"
                "𓋜┊𓆩  𓆪\n"
...
@iqqhtani.on(admin_cmd(pattern="بايو4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "🜟 ↬ ᑎᗩᗰE ، • •😌❤️\n"
                "🜟 ↬ ᖴᖇOᗰ ، IRΔQ 🇮🇶\n"
...
@iqqhtani.on(admin_cmd(pattern="بايو5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "𓂅| •\n" "𓂅| •\n" "𓂅| •🖤☁️ .\n" "• 𝙸 𝙻𝙸𝙺𝙴 𝙼𝙾𝚄𝙽𝚃𝙰𝙸𝙼𝚂 𝙽𝙾𝚃 𝙵𝙰𝙻𝙻 .")
@iqqhtani.on(admin_cmd(pattern="بايوهات1(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
— — — — — — — — —
`𓆦 : أيـۿ  ◡‌ 💙🧿.
...
— — — — — — — — —
""")
@iqqhtani.on(admin_cmd(pattern="بايوهات2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
⠀⠀
⠀ ⠀ ⠀⠀⠀`. ғʀᴏᴍ #𝙸𝚛𝚊𝚚 ↻.
