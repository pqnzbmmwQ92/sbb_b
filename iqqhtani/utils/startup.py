...
LOGS = logging.getLogger("سورس ايــثــون \n ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين سورس ايــثــون العام", iqqhtani, Config.TG_BOT_USERNAME, descript        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين سورس ايــثــون الخاص", iqqhtani, Config.TG_BOT_USERNAME, descript        )
